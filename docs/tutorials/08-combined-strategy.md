...
使策略在不同市场环境中均保持一定的选股能力（参考 [Tutorial 07: 多因子选股](07-multi-factor.md)）。
...
参考 [Tutorial 06: 行业轮动](06-sector-rotation.md)，在多因子得分的基础上加入行业轮动维度。
...
### 4.1 RSI 均值回归入场（Tutorial 06: RSI 均值回归）
...
参考 [Tutorial 03: 策略优化与改进](03-optimization.md)，在大盘趋势向下时暂停买入：
...
每月加入 PE/PB 财务因子（参考 [Tutorial 07: 多因子选股](07-multi-factor.md) 第 5 节），但仅作为辅助参考：
...
| 教程 | 相关内容 |
|------|---------|
| [Tutorial 06: RSI 均值回归](05-rsi-mean-reversion.md) | RSI 原理、布林带对比 |
| [Tutorial 07: 行业轮动](06-sector-rotation.md) | 动量轮动、多维度行业评分 |
| [Tutorial 08: 多因子选股](07-multi-factor.md) | Z-Score 标准化、IC 检验 |
| [Tutorial 03: 策略优化与改进](03-optimization.md) | 大盘过滤、止损设计 |
