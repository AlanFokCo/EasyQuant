...
!!! abstract "本篇导览"
    ...
    | **预计** | 60～90 分钟（可查表跳读） |
    | **若已熟练** | 请直接开始 [Tutorial 00](../00-getting-started.md) |

> 本文面向**几乎没有 Python 经验**的读者。如果你已经能熟练使用 pandas、numpy，可直接跳过本文，从 [Tutorial 00](../00-getting-started.md) 开始。
...
- **继续前置知识**：[技术分析基础概念](technical-concepts.md)、[A 股市场基础知识](ashare-knowledge.md)
