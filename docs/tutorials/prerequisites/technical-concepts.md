...
!!! abstract "本篇导览"
    ...
    | **预计** | 45～60 分钟 |
    | **若已熟练** | 请从 [Tutorial 00: 环境与量化基础](../00-getting-started.md) 或 [Tutorial 01: 写第一个策略](../01-first-strategy.md) 继续 |

> 本文面向**从未接触过技术分析**的读者。如果你已经了解均线、RSI、MACD，可直接跳过，从 [Tutorial 00: 环境与量化基础](../00-getting-started.md) 开始。
...
完整函数列表和参数说明见 [工具库参考](../../reference/utils.md)。

---

## 12. 下一步

- **继续前置知识**：[A 股市场基础知识](ashare-knowledge.md)
- **进入正式教程**：[Tutorial 00：环境与量化基础](../00-getting-started.md)
- **Tutorial 06: RSI 均值回归策略** 详细讲解 RSI 均值回归策略的实战应用：[05-rsi-mean-reversion.md](../05-rsi-mean-reversion.md)
