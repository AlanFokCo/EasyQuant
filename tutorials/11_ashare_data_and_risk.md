...
!!! abstract "本篇导览"
    ...
    | **预计用时** | 约 30 分钟 |
    | **前置** | [Tutorial 04](04_strategy_optimization.md)（策略优化） |
...
**文档索引：** [`doc/README.md`](../doc/README.md) | **相关示例：** [Example 25](../examples/25_ashare_market_sentiment.py)
...
- **[Example 25](../examples/25_ashare_market_sentiment.py)**：A 股市场情绪指标——完整演示四个数据 API 的用法
- **[Example 08](../examples/08_lifecycle_callbacks.py)**：生命周期回调——`before_trading_start` 与 `after_trading_end` 的详细用法

### 下一步

- [Tutorial 05](05_live_trading.md)：将带风控的策略部署到模拟交易
- [Tutorial 10](10_agent_optimization.md)：用参数化方法优化本篇的策略参数
