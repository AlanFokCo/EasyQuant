...
- **[Tutorial 04: 策略优化与改进](04_strategy_optimization.md)** — 参数调优、归因分析，检验多因子策略的稳健性
- **[Tutorial 07: 行业轮动](07_sector_rotation.md)** — 将多因子选股与行业轮动结合，先选行业再选股
- **[Example 16: 多因子选股策略](../examples/16_multi_factor_strategy.py)** — 完整可运行的多因子示例代码
- **[Example 09: 绩效归因分析](../examples/09_attribution_analysis.py)** — 对策略收益进行深度归因，了解选股效应和配置效应
- **[工具库参考](../doc/utils_reference.md)** — `utils.zscore`、`utils.rolling_sharpe`、`utils.max_drawdown` 等工具的详细说明
