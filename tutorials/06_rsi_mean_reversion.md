...
| **相关示例** | 本教程 | [Example 14](../examples/14_bollinger_strategy.py) |
...
- **[Tutorial 07: 行业轮动策略](07_sector_rotation.md)** — 利用 A 股行业轮动特性，通过板块切换赚取超额收益
- **[Tutorial 08: 多因子选股](08_multi_factor.md)** — 结合动量、价值、质量多个因子，系统化选股
- **[Tutorial 04: 策略优化与改进](04_strategy_optimization.md)** — 参数调优、避免过拟合、归因分析
- **[Example 14: 布林带策略](../examples/14_bollinger_strategy.py)** — 另一种经典均值回归策略的完整代码
- **[Example 18: 多策略对比](../examples/18_strategy_comparison.py)** — 在同一股票上横向对比多种策略
